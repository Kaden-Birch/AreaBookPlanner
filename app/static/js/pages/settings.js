...
export async function renderLegacySettings(container) {
  ...
  import('../meraki.js').then(m=>m.merakiSettings(container)).catch(e=>toast(e.message,'error'));
  import('../integration-sync.js').then(m=>m.syncSettings(container)).catch(e=>toast(e.message,'error'));
  // Price book
