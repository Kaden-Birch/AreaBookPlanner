...
CLINICS = [
    {"name": "Crowfoot Medical Clinic", "address": "400 Crowfoot Cres NW", "postal_code": "T3G 5H6",
     ...
     "display_address": "Unit 210, 400 Crowfoot Cres NW",
     "hours": {"mon": {"open": "08:00", "close": "17:00"}, "tue": {"open": "08:00", "close": "17:00"},
               "wed": {"open": "08:00", "close": "17:00"}, "thu": {"open": "08:00", "close": "17:00"},
               "fri": {"open": "08:00", "close": "16:00"}, "sat": {"open": "09:00", "close": "13:00"},
               "sun": {"closed": True}},
     "mrr": 1500, "contract_start": "2024-02-12", "contract_term_months": 36,
     "contract_end": (datetime.now() + timedelta(days=45)).date().isoformat()},
    {"name": "Beltline Family Practice", "address": "1121 12 Ave SW", "postal_code": "T2R 0J3",
     ...
     "it_provider": "TechMedic MSP", "competitor_contract_end": (datetime.now() + timedelta(days=30)).date().isoformat(),
    ...
    {"name": "Southcentre Dental", "address": "100 Anderson Rd SE", "postal_code": "T2J 3V1",
     ...
     "outcome_notes": "Went with TechMedic MSP this round."},
    {"name": "Westbrook Physiotherapy", "address": "1200 37 St SW", "postal_code": "T3C 1S2",
     ...
     "it_provider": "TechMedic MSP", "competitor_contract_end": (datetime.now() + timedelta(days=75)).date().isoformat(),
    ...
    {"name": "Kensington Health Group", "address": "1140 Kensington Rd NW", "postal_code": "T2N 3P1",
     ...
     "it_provider": "CalgaryTech Solutions", "competitor_contract_end": (datetime.now() + timedelta(days=150)).date().isoformat(),
